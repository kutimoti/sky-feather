...
let g:airline#themes#sky_feather#palette = {}
...
let g:airline#themes#sky_feather#palette.normal = 
    \ airline#themes#generate_color_map(s:normal_outer, s:normal_middle, s:normal_inner)
let g:airline#themes#sky_feather#palette.normal_modified =
...
let g:airline#themes#sky_feather#palette.insert = 
    \ airline#themes#generate_color_map(s:insert_outer, s:insert_middle, s:insert_inner)
let g:airline#themes#sky_feather#palette.insert_modified = 
    \ copy(g:airline#themes#sky_feather#palette.normal_modified)
...
let g:airline#themes#sky_feather#palette.replace =
    \ airline#themes#generate_color_map(s:replace_outer, s:replace_middle, s:replace_inner)
let g:airline#themes#sky_feather#palette.replace_modified = 
    \ copy(g:airline#themes#sky_feather#palette.insert_modified)


" Visual mode
let s:visual_outer = [s:fg, s:sky2, s:dark_c, s:yellow_c]
let s:visual_middle = s:normal_middle
let s:visual_inner = [s:fg, s:bg, s:yellow_c, s:med_lo_c]
let g:airline#themes#sky_feather#palette.visual = 
    \ airline#themes#generate_color_map(s:visual_outer, s:visual_middle, s:visual_inner)
let g:airline#themes#sky_feather#palette.visual_modified = 
    \ copy(g:airline#themes#sky_feather#palette.insert_modified)
...
let g:airline#themes#sky_feather#palette.inactive = 
    \ airline#themes#generate_color_map(s:inactive, s:inactive, s:inactive)
let g:airline#themes#sky_feather#palette.inactive_modified = 
